...
export function stockDataToNotes(data, notes_dict) {
...
// let myFrequency = 446; // Example frequency
// let closestNote = findClosestNote(246.08120161367222, notes_to_freq_dict);

// // console.log("calculateNoteFrequencies()", notes)
